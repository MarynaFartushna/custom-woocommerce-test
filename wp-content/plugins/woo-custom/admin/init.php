...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	...
	add_action( 'woocommerce_after_add_to_cart_button', 'custom_woo_add_custom_fields' );
	...
	function custom_woo_add_custom_fields() {
        ...
        <div class="custom-propose-wrapper">
            <p class="" for="custom-propose"><?php esc_html_e( 'Your custom propose:', 'woocommerce' ); ?></p>
